			...
			<section class="bg-white">
				<div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
					...
					<div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-sm lg:px-36">
						...
						<div class="flex flex-wrap justify-center text-lg font-semibold items-center mt-8 text-gray-500 sm:justify-between">
							...
							<a href="https://github.com/mavina15" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800">
								<svg class="w-12 h-12 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
							...
							<a href="https://linkedin.com/in/mavinabeltran" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800">
								<svg class="w-12 h-12 text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">

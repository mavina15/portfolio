	...
	return (
		...
		<div id="wnba" class="container mx-auto my-auto p-4 max-w-5xl">
			<div class="mx-auto max-w-2xl p-8">
				...
				<section>
					<h2 class="text-xl font-bold mb-2">1. Data Cleaning</h2>
				...
				<section>
					<h2 class="text-xl font-bold mb-2">2. Feature Selection</h2>
				...
				<section>
					<h2 class="text-xl font-bold mb-2">3. Model Creation and Evaluation</h2>
				...
				<section>
					<h2 class="text-xl font-bold mb-2">4. Predicting Finals</h2>
				...
				<section>
					<h2 class="text-xl font-bold mb-2">5. Conclusion</h2>

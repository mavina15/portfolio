			...
			<section class="bg-white">
				<div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-8 lg:px-6">
					<div class="max-w-screen-md mb-4 lg:mb-8">
						<h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">experience</h2>
					</div>

					<div class="grid sm:grid-cols-2 lg:grid-cols-2 items-left gap-6">
						<a class="group flex gap-y-6 size-full hover:bg-gray-100 rounded-lg p-5 transition-all" href="https://codelabdavis.medium.com/coursewise-2b9547becdf8">
							<span className="flex-shrink-0 text-5xl mt-0.5 me-6" role="img" aria-label="Busts in Silhouette">👥</span>
							<div>
								<div>
									<h4 class="text-lg block font-bold text-pink-500">winter - spring 2023</h4>
									<h3 class="text-md block font-bold text-gray-400">junior developer and project manager</h3>
									<h2 class="text-2xl block font-bold text-gray-800 mb-3">@ codelab</h2>
						...
						<a class="group flex gap-y-6 size-full hover:bg-gray-100 rounded-lg p-5 transition-all" href="/wnba">
							<span className="flex-shrink-0 text-5xl mt-0.5 me-6" role="img" aria-label="Cow Face">🐮</span>
							<div>
								<div>
									<h4 class="text-lg block font-bold text-pink-500">winter - spring 2022</h4>
									<h3 class="text-md block font-bold text-gray-400">junior developer</h3>
									<h2 class="text-2xl block font-bold text-gray-800 mb-3">@ uc davis math</h2>

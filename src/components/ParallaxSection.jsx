	...
	return (
		<div className="relative overflow-hidden min-h-screen">
			...
			<section id="home" className="bg-white bg-opacity-80 py-20 px-4 m-20">
				<div className="container mx-auto max-w-7xl">
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
						<div className="col-span-1 bg-white border border-gray-200 rounded-lg shadow-lg p-6">
							<div className="flex flex-col items-center pb-5">
								{/* Profile Image */}
								<div className="w-32 h-32 rounded-full overflow-hidden bg-gradient-to-tr from-pink-500 to-pink-300 flex items-end justify-center">
									<img className="w-24 h-24 object-cover mb-2" src={profilePic} alt="profile image" />
								</div>
								<span className="text-xl text-gray-400 lowercase mt-2">He, Him, His</span>
								<h5 className="mb-1 text-2xl text-gray-900 mt-2">Mel Avina-Beltran</h5>
								<span className="mb-2 text-xl font-semibold text-pink-500 lowercase">Data Scientist + Software Engineer</span>
								<p className="font-bold text-center mt-2">Data scientist and software engineer passionate about leveraging technology to solve real-world problems.</p>
								{/* Contact Links */}
						...
						<div className="col-span-2 bg-white p-6 rounded-lg shadow-md">
							<div className="bg-opacity-20 shadow-md rounded-lg p-6">
								...
								<p className="text-md text-center text-gray-400 mb-4">2024</p>
								...
								<h2 className="underline font-semibold mb-2">Projects</h2>
								<p className="mb-2">🏀 WNBA Matrix</p>
								<p className="mb-4">🩻 Breast Cancer Classification</p>
								<h2 className="underline font-semibold mb-2">Leadership</h2>
								<p className="mb-2">🌈 President of La Familia de UC Davis</p>
								<p className="mb-2">⚛️ Academic Officer of CALESS (the Chicanx and Latinx Scientists and Engineers Society)</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section id="about" className="bg-white bg-opacity-80 py-20 px-4 mb-20">
				<div className="container mx-auto max-w-7xl">
					<h2 className="text-3xl font-bold text-gray-900 text-center mb-8 lowercase">About Me</h2>
					<p className="mt-8">
